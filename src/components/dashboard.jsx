        ...
        <div className="flex flex-col lg:flex-row mt-8">
          ...
          <div className="lg:w-1/3 w-full mt-8 lg:mt-0">
            <div className="bg-white p-4 rounded-lg">
              ...
              <div className="mt-4">
                <p className="text-black">Lorem ipsum dolor sit amet consectetur adipisicing elit. Ad, ratione. Voluptate molestiae nisi maxime earum quaerat, libero quas recusandae nam harum voluptatum ullam sapiente impedit dignissimos rerum quod, in eum?
